...
<form class="form"  action="fir_register.php">
    ...
    <label>
        <input class="input" type="text" placeholder="" required name='password'>
        <span>Password</span>
    </label>
    
    <button class="submit btn btn-primary" type="submit" name="register"><a href="" class='text-black'>Submit</a></button>
